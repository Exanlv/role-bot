...
export class SelfAssignRolesTest extends BaseTest implements IUnitTest {
	...
	public async runTests(): Promise<void> {
		...
		await this.testServer.members.find((m: GuildMember) => m.id === this.client.user.id).addRole(this.testingRole);
