...
class RoleBot {
	...
	private configs: {[id: string]: ServerConfig} = {};
	...
	private handleOnReady() {
		...
		console.log('Ready handling initialized');
	}
	...
	private handleOnGuildCreate() {
		...
		console.log('Guild create handling initialized');
	}
	...
	private handleOnGuildDelete() {
		...
		console.log('Guild delete handling initialized');
	}
	...
	private handleOnRawMessageReacts() {
		...
		console.log('Raw message reacts handling initialized');
	}
	...
	private handleOnCustomReactAdd() {
		...
		console.log('Custom reacts adding handling initialized');
	}
	...
	private handleOnCustomReactRemove() {
		...
		console.log('Custom reacts removing handling initialized');
	}
	...
	private handleOnChannelDelete() {
		...
		console.log('Channel delete handling initialized');
	}
	...
	private handleOnRoleDelete() {
		...
		console.log('Role delete handling initialized');
	}
	...
	private handleOnRawMessageDelete() {
		...
		console.log('Raw message delete handling initialized');
	}
}

new RoleBot(GlobalConfig.token);
