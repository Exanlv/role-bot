...
export class SelfAssignRolesTest extends BaseTest implements UnitTest {
	...
	public async runTests() {
		...
		await this.simpleTest(
			`!rbt sa r a r:{${this.fakeRoleName}}`,
		...
		await this.simpleTestDoubleResponse(
			`!rbt sa r a r:{${this.testingRole.name}}`,
			'``> enter category name``',
		...
		await this.simpleTest(
			`!rbt sa r a r:{${this.testingRole.name}} c:{${this.fakeCategoryName}}`,
		...
		await this.simpleTest(
			`!rbt sa r a r:{${this.testingRole.name}} c:{${this.categoryName}}`,
		...
		await this.simpleTest(
			`!rbt sa r r r:{${this.testingRole.name}} c:{${this.fakeCategoryName}}`,
		...
		await this.simpleTest(
			`!rbt sa r r r:{${this.testingRole.name}} c:{${this.secondCategoryName}}`,
		...
		await this.simpleTest(
			`!rbt sa r r r:{${this.testingRole.name}} c:{${this.categoryName}}`,
